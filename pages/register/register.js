...
Page({
  ...
  codeTap: function (e) {
    ...
    if (reg.test(this.data.phone)) {
      ...
      app.wxRequest('api/apiservice/sms/v1/sendsms', { phone: this.data.phone, type: 2 }, 'POST', function (res) {
  ...
  isCode: function () {
    ...
    if ( password == isPassword ){
      app.wxRequest('api/apiservice/user/v1/register', {
        phone: phone, password: isPassword, code: userCode
      }, 'POST',
        function (res) {
          if (res.data.code == "0") {
